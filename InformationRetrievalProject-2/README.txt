...
Therefore, this achrive is also a eclipse project structure and could be imported easily. 
...
For the simpliest way to start the programm, you can simply use the Executable Jar File named 'IRSystemApplciation'.
However, if you want to start the programm of the project imported within eclipse for example, you need to run the main-method of the UserInterface class.

The classes Evaluation and PortersStemmer also contain mainmethods.
...
Jar File: "stanford-corenlp-2017-04-14-build": Stanford CoreAPI
