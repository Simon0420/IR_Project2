 ...
 * 
 * 
 *        Class to find the stem or lemma of a word by using heuristics with
...
public class Lemmatization {
	...
	/**
	 * 
	 * Variable to hold the initial word and once all operations have been
	 * applied, the lemma.
	 * 
	 */
	...
	static final private String[] suffixes = { "!", "ly", "ing", "ed", "en", "er", "est", "n't", "s", "ian", "ize",
			"ise", "fy", "ful", "able", "ible", "hood", "ness", "less", "ism", "ment", "ist", "ment", "al", "ish",
			"ify", "acy", "ance", "ence", "dom", "or", "ity", "ty", "ship", "sion", "tion", "ate", "esque", "ic",
			"ical", "ious", "ous", "ive" };
	...
	static final private String[] prefixes = { "an", "ante", "anti", "auto", "circum", "co", "com", "con", "contra",
			"de", "dis", "en", "ex", "extra", "hetero", "homo", "hyper", "homo", "hyper", "il", "im", "in", "ir",
			"inter", "intra", "in", "macro", "micro", "mono", "non", "omni", "post", "pre", "pro", "sub", "syn",
			"trans", "tri", "uni", "un" };
